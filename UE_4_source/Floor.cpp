...
AFloor::AFloor()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> MeshAsset(TEXT("StaticMesh'/Game/floor.floor'"));
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> MaterialAsset(TEXT("Material'/Game/floorTMaterial.floorTMaterial'"));
	...
	static ConstructorHelpers::FObjectFinder<UMaterialInterface> EndpointMaterialAsset(TEXT("Material'/Game/endpointMaterial.endpointMaterial'"));
